...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final results = hasQuery ? searchFastHacks(_q) : <FastHack>[];
    final empty = hasQuery && results.isEmpty;
        ...
        children: [
          DecoratedBox(
            decoration: const BoxDecoration(
              color: Color(0xFFF3F7EE),
              border: Border(bottom: BorderSide(color: Color(0x1A0F3A27))),
            ),
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'Search the restaurant guides available on this device using ordinary words.',
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'Try fewer specifics, or browse the places we cover — it’s often faster.',
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 2),
                  Text(
                    '${results.length} orders worth a look',
                    style: AppText.h2(),
                  ),
                  const SizedBox(height: 8),
                  Text(
